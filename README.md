...
<details>
    ...
    The number of prepending hashes defines font size of the headlines. The fewer hashtags used the larger the heading.
</details>
<details>
...
<details>
    ...
    <code>
    To generate a table, use the vertical line | to separate each column. With three or more dashes --- you can create a column’s header.
     To generate lists you can either use numbers starting with "1." or use dashed in front of each line.
    </code>
</details>
...
<details>
    ...
    When generating the files the jobname can be defined individually.
</details>
...
<details>
    ...
    The title as well as auther and date is displayed in the center of the first page while the "Hello, world!" text starts on the second page.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    A header "1 Intro" is added above the "Hello, world!" text.
</details>

*90 minutes were over here*
